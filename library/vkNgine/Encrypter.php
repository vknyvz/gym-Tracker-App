 ...
 */
class vkNgine_Encrypter 
{
	const vkNgine_LOGIN_SECRET = 'fg4s8sdf';
     ...
     *  @param boolean zendUrlEncode encodes result to work with zend framework urls
     *
     *  @return string iv+ciphertext+mac or
     * boolean false on error
     */
     public function encrypt($msg, $k, $base64 = false, $zendUrlEncode = false)
     {
        ...
        if ( $zendUrlEncode ) {
        	$msg = str_replace('/', 'A1AA', $msg);
    		$msg = str_replace('=', 'A2AA', $msg);
    		$msg = str_replace('+', 'A3AA', $msg);
        }
      ...
      * boolean false on error
      */
      public function decrypt($msg, $k, $base64 = false, $zendUrlEncode = false)
      {
      	  if ($zendUrlEncode){
      	     $msg = str_replace('A1AA', '/', $msg);
    	 	 $msg = str_replace('A2AA', '=', $msg);
